...
const benefits = [
  {
    ...
    content:
      'Deseas obtener los reportes estadísticos en documentos digitales.',
  },
  {
    ...
    <DefaultLayout>
      ...
      <VStack as='main' maxWidth={1250} margin='auto'>
        ...
        <HStack
          ...
          textAlign='center'
        >
          {benefits.map(({ src, title, content }, index) => (
            <VStack key={`benefit-index-${index}`} width='250px' gap={4}>
              <Image boxSize={150} alt={title} src={src} />
