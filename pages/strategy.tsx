...
const principal_text = [
  "La Estrategia Metropolitana de Juventudes (EMJ) fue promulgada el\n" +
    "              25 de noviembre de 2020. Es una guía de acción territorial para la\n" +
    "              implementación de servicios públicos a favor de las juventudes a\n" +
    "              nivel de Lima Metropolitana, en el marco de la Política Nacional\n" +
    "              de la Juventud.",
  "En su desarrollo participaron las tres instancias del Sistema\n" +
    "              Metropolitano las cuales fueron: el .Comité Metropolitano de\n" +
    "              Políticas de Juventud, la Coordinadora Metropolitana de Programas\n" +
    "              Municipales de Juventud y el Consejo Metropolitano de\n" +
    "              Participación de la Juventud.",
  "La EMJ tiene 8 ejes estratégicos, los cuales cuentan con:\n" +
    "              indicadores, expectativas de futuro y servicios públicos\n" +
    "              validados. Las principales problemáticas en cada eje, fueron\n" +
    "              identificadas a partir de los encuentros interdistritales por\n" +
    "              mancomunidades de Lima Norte, Lima Este, Lima sur y Lima Centro,\n" +
    "              en las cuales participaron las juventudes de 15 a 29 años.",
];
      ...
      <VStack as="main" maxW={1250} margin="auto" p={4} gap={8} my={8}>
        <VStack maxW={1200} gap={8}>
          ...
          <VStack textAlign="justify" gap={4} p={4}>
            {principal_text.map((paragraph: string, iter: number) => (
              <Text key={`paragraph-${iter}`}>{paragraph}</Text>
            ))}
          </VStack>
        </VStack>
        <VStack p={4} gap={8}>
        ...
        <Box width={"100%"}>
          <AspectRatio minW="250px" maxH={"500px"} ratio={{ base: 16 / 9 }}>
            <iframe
        ...
        <VStack>
          <Heading paddingBottom={2}>Rendición de cuentas</Heading>
          <Image alt="rendicion de cuentas" src={linkDrive} />
        </VStack>
        <Center height={150}>
