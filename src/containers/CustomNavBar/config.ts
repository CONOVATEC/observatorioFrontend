export const menuItems = [
  ...
  { label: 'Politicas Juveniles', isCollapsable: false, href: '', subLabels: [{ label: 'Estrategia Metropolitana de Juventudes', href: '/strategy' }, { label: 'Política Nacional de Juventud', href: '/national' }] },
