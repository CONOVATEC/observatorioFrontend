...
export const useDirectiveHandleProps = () => {
  const handleRenderCarousel = ({ url_image, alt, fullName, position }: SectionAboutCarouselProps, index: number) => (
    <HStack
      as={Box}
  ...
  const handleRenderStack = ({ url_image, alt, fullName, position }: SectionAboutCarouselProps, index: number) => (
    <HStack
      as={Box}
