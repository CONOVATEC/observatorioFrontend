  ...
  return (
    <HStack
      ...
      <VStack
        ...
        <Text
          pr={{ base: '0%', lg: '30%' }}
          textAlign={{ base: 'center', lg: 'start' }}>Nuestro próposito es informar sobre los retos de las juventudes, buscando incetivar acciones para transformar la sociedad hacia un bien común.</Text>
      </VStack>
      <VStack
        ...
        <Text
          textAlign={'center'}>Ser el mejor proyecto informativo - educativo del Perú, reconocido por facilitar datos sociodemográficos, socioeconómicos y políticas de la población joven.</Text>
      </VStack>
      <VStack
        width={{ base: 'full', md: '60%', lg: '35%' }}
        ...
        <Text fontWeight={'bold'} fontSize={'2xl'}>Misión</Text>
        <Text textAlign={'center'}>Generar espacios formativos, basados en datos y  asistir a las organizaciones juveniles a nivel nacional.</Text>
      </VStack>
    </HStack >
  )
}
